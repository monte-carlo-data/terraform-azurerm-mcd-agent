...
| azure_storage_auth_type      | The authentication method for Azure Blob Storage. Set to `"service_principal"` to use SP auth. When unset, managed identity is used (default, backwards compatible).                                                                                                                                                                                                                                                                 | string   | null                              |
| azure_sp_tenant_id           | Entra ID tenant ID for service principal authentication. Required when `azure_storage_auth_type` is `"service_principal"`.                                                                                                                                                                                                                                                                                                           | string   | null                              |
| azure_sp_client_id           | App registration client ID for service principal authentication. Required when `azure_storage_auth_type` is `"service_principal"`.                                                                                                                                                                                                                                                                                                   | string   | null                              |
| azure_sp_client_secret       | App registration client secret for service principal authentication. Required when `azure_storage_auth_type` is `"service_principal"`. Sensitive.                                                                                                                                                                                                                                                                                    | string   | null                              |
| azure_storage_account_url    | Optional blob service URL for Private Link or sovereign clouds. Falls back to `https://{account_name}.blob.core.windows.net` when unset. Must use the `https://` scheme.                                                                                                                                                                                                                                                            | string   | null                              |
